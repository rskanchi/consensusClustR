...
***Open the `<project_name>.R` file from your project folder and provide values for the consensus clustering arguments.*** This is the most crucial step because these parameters determine the stability, number, and structure of the clusters you’ll discover. If you have mixed features (continuous and categorical), please feel free to write custom distance functions for the arguments `sample.dist.method` and `expr.dist.method`.
